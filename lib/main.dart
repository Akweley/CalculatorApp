                  ...
                  children: [
                    ...
                    Row(
                        ...
                        children: [
                          ...
                          keyPadButton('6', Color.fromRGBO(40, 53, 73, 1)),
                          operatorButton('-'),
                        ]),
                    SizedBox(
                      height: 15,
                    ...
                    Row(
                        mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                        children: [
                          keyPadButton('1', Color.fromRGBO(40, 53, 73, 1)),
                          keyPadButton('2', Color.fromRGBO(40, 53, 73, 1)),
                          keyPadButton('3', Color.fromRGBO(40, 53, 73, 1)),
                          operatorButton('x'),
                        ]),
                    SizedBox(
                      height: 15,
                    ...
                    Row(
                        ...
                        children: [
                          ...
                          keyPadButton('00', Color.fromRGBO(40, 53, 73, 1)),
